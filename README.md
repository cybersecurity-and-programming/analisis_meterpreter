...
1. Detección y parsing de tráfico asociado a Meterpreter
2. Identificación de comandos y fases de interacción
3. Visualización clara de eventos relevantes
4. Pensado para entornos de DFIR y análisis educativo
